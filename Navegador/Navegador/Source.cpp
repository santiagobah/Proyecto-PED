...
int main() {
    ...
    do
    {
        ...
        case 1:
        {
            ...
            contador_pestañas++;
            historial.push_back(nueva_pagina); //se van agregando todas las páginas que se vayan visitanto
        ...
        case 12:// No es el case correcto, pero voy poniendo el código para mostrar el historial completo del programa
            cout << endl;
            cout << "----------HISTORIAL----------" << endl;
            cout << endl;
            if (historial.size() == 0)
